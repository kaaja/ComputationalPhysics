...
\begin{minipage}{.49\textwidth} 
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.99\textwidth]{/home/karl/doc/subj/att/fys4150/project3/resultsKeep/plots/sunEarthfinalTime10N1000ForwardEuler.png}
...
\begin{minipage}{.49\textwidth} 
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.99\textwidth]{/home/karl/doc/subj/att/fys4150/project3/resultsKeep/plots/sunEarthfinalTime10000N10000000ForwardEuler.png}
...
\begin{minipage}{.33\textwidth} 
	\begin{figure}[H]
		...
		\caption{Sun-Earth system. Escape valocity. Orbits. \\ \textit{No escape just below escape velocity.}
		\label{1}
	\end{figure}
\end{minipage}\hfill
\begin{minipage}{.33\textwidth} 
	\begin{figure}[H]
		...
		\caption{Sun-Earth system. Escape valocity. Orbits.  \\ \textit{Constant radial distance at escape valocity}}
		\label{1}
	\end{figure}
\end{minipage}\hfill
\begin{minipage}{.33\textwidth} 
\begin{figure}[H]
	...
	\caption{Sun-Earth system. Escape valocity. Orbits.  \\ \textit{Escape when above escape velocity}}
	\label{1}
\end{figure}
\end{minipage}\hfill
\vspace{2ex}
...
\begin{figure}[H]
	...
	\caption{Sun-Earth system. Escape valocity. Radial distances  \\ \textit{Escape velocity is an ustable equilibrium}}
	\label{1}
\end{figure}
