...
\begin{minipage}{.45\textwidth} 
	\begin{figure}[H]
		...
		\caption{2D. Timing. Analytical Solution using 30 points in Gaussian quadrature.\\ \textit{The evaluation of the analytical solution takes 1000 times longer than the numerical solution of the implicit 2D scheme.}}
